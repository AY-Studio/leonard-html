...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: true,
    rollupOptions: {
      // LAUNCH SCOPE: only the initial-launch pages are built. The rest are
      // commented out (not deleted) and can be switched back on by uncommenting
      // their line here AND restoring their nav/links (search "LAUNCH:" across
      // the HTML). See README.md.
      input: {
        ...
        // --- Not in the initial launch (uncomment to re-enable) ---
